...
export default function Login({ onLoginSuccess }: LoginProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 relative">
      ...
      <div className="absolute w-[400px] h-[400px] rounded-full bg-blue-100/40 top-10 left-10 blur-3xl pointer-events-none" />
      <div className="absolute w-[300px] h-[300px] rounded-full bg-cyan-100/30 bottom-10 right-10 blur-3xl pointer-events-none" />

      <div className="w-full max-w-md bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden z-10 transition-all duration-300">
